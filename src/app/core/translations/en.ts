export const en = {
  ...
  home: {
    hero: {
      ...
      titleLine2: 'Stronger brand. Better results.',
      ...
      subtitleSoft: ' building brand awareness, attracting new patients, and supporting the growth of your practice.',
    ...
    checklist: {
      ...
      items: [
        'We\'ll make sure registration answers every call',
        'We\'ll shorten response times for patients',
        'We\'ll fill free slots in doctors\' schedules',
        'We\'ll make your ads start producing results',
        'We\'ll make your website start attracting patients',
        'We\'ll make social media start generating inquiries',
        'We\'ll show you where your patients come from',
        'We\'ll implement missing procedures',
        'We\'ll set up sales reports',
        'We\'ll teach you to measure effectiveness',
        'We\'ll help you open a new clinic',
        'We\'ll increase your number of private patients',
      ],
